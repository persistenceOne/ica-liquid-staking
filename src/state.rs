...
use crate::msg::{AssetData, LsConfig, StakedLiquidityInfo, UnstakedLiquidityInfo};
...
pub const UNSTAKED_LIQUIDITY_INFO: Item<UnstakedLiquidityInfo> = Item::new("unstaked_liquidity_info");
